...
EOF
  ...
  echo "for you:"
  echo ""
  echo "* Documentation  - https://ewc-docs.extremenetworks.com/solutions/dcfabric/index.html"
  echo "* Support        - support@extremenetworks.com"
  echo ""
  echo "Thanks for installing Extreme Workflow Composer and the DC Fabric suite!"
}
